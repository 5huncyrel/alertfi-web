...
SECRET_KEY = 'django-insecure-!!-f%v565&ma()0#lst7jv3@*yqa5s!7qnen(t@uv5$#5$04n8'
...
# Cache settings for login attempt limiting
CACHES = {
    'default': {
...
# Email backend settings for sending verification emails (use an SMTP backend or console for testing)
...
EMAIL_HOST_PASSWORD = ' rdij msoe ccju xexy'         # your Mailtrap password
